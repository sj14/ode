...
func ExampleEulerPopulation() {
	y := EulerForward(0, 10, 100, yStartPop, populationGrowthSimple)
...
func ExampleEulerSIR() {
	y := EulerForward(0, 10, 100, yStartSIR, sir)
...
func ExampleRungeKuttaPopulation() {
	yz := RungeKutta4(0, 10, 100, yStartPop, populationGrowthSimple)
...
func ExampleRungeKuttaSIR() {
	y := RungeKutta4(0, 10, 100, yStartSIR, sir)
